...
public class Form7 {
    ...
    @Value("${file.formSeven.pdf.dir:${file.unsigned.pdf.dir:./unsigned-pdf/}}")
    ...
    public String createPdf(RegistrationMstr regMstr) {
        ...
        try {
            ...
            document = new Document(pdf, PageSize.A4.rotate());
                ...
                // para1.add(new Text(ePermitUtil.isNeitherNullNorEmpty(assessmentBean.getMarketCode())
                ...
                // Original AssessmentBean-dependent lines from provided code (kept as requested)
                // para2.add(new Text((ePermitUtil.isNeitherNullNorEmpty(assessmentBean.getToDate())
                //         ? sdf.format(assessmentBean.getToDate()) : "........................................")));
                // para2.add(new Text("Licence No.: ")).add(assessmentBean.getTraderLicenceeNo());
                ...
                Table table = new Table(UnitValue.createPercentArray(new float[] { 5, 30, 10, 30, 13, 13, 15, 3, 3, 12, 3 }));
                ...
                para4 = new Paragraph().setFont(font).setFontSize(BODY_FONT_SIZE);
                para4.add(new Text("Amount of market fee recovered from purchaser where he is not a licensee, with data (RS)"))
                    .setVerticalAlignment(VerticalAlignment.MIDDLE)
                    .setTextAlignment(TextAlignment.LEFT).setMultipliedLeading(1.2f);
                table.addCell(createCell(para4, 1, 1, 0, false).setPaddingLeft(8).setPaddingRight(8).setPaddingTop(10)
                    .setBorderTop(new SolidBorder(1)));
                ...
                // AssessmentBean-dependent logic from provided Form7 (kept commented as requested)
                // Format formatter = new SimpleDateFormat("dd/MM/yyyy");
                // for (AssessmentBean bean : assessmentBeanList) {
                //     table4.addCell(createCell(new Paragraph(new Text(
                //             ePermitUtil.isNeitherNullNorEmpty(bean.getCreatedOn()) ? formatter.format(bean.getCreatedOn()) : "")), 1,
                ...
                //         table4.addCell(createCell(new Paragraph(new Text(ePermitUtil.isNeitherNullNorEmpty(bean.getSellerName())
                ...
                //         table4.addCell(createCell(new Paragraph(new Text(ePermitUtil.isNeitherNullNorEmpty(bean.getBillNo())
                ...
                //     }
                //
                //     table4.addCell(createCell(new Paragraph(new Text(ePermitUtil.isNeitherNullNorEmpty(bean.getCommodityId())
                //             ? bean.getCommodityId().toUpperCase() : "")), 1, 1, 0, false));
                //     table4.addCell(createCell(new Paragraph(new Text(ePermitUtil.isNeitherNullNorEmpty(bean.getQty())
                //             ? String.valueOf(bean.getQty()) : "0")), 1, 1, 0, false));
                //     table4.addCell(createCell(new Paragraph(new Text(
                //             ePermitUtil.isNeitherNullNorEmpty(bean.getRate()) ? String.valueOf(bean.getRate()) : "0")),
                //             1, 1, 0, false));
                //     table4.addCell(createCell(new Paragraph(new Text(ePermitUtil.isNeitherNullNorEmpty(bean.getTradeValue())
                //             ? String.valueOf(bean.getTradeValue()) : "0")), 1, 1, 0, false));
                //     table4.addCell(createCell(new Paragraph(new Text(ePermitUtil.isNeitherNullNorEmpty(bean.getMarketFee())
                ...
                // Legacy file naming from provided AssessmentBean version (kept commented as requested)
                // filePath = filePath + assessmentBean.getTraderLicenceeNo() + "_" + assessmentBean.getMarketCode() + "_"
