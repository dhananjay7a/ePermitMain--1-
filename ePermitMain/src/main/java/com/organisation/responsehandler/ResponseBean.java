...
public class ResponseBean {
    ...
    public void AllResponse(String type, Object data) {
        ...
        switch (type) {
            ...
            case "PWDINVAL":
                this.response.setCode("400");
                this.response.setMessage("Password  is Not Matched !!");
                break;
            case "PWDCHANGE":
                this.response.setCode("200");
            ...
            case "PasswordChangedSuccessfully":
            	this.response.setCode("200");
            	this.response.setMessage("PasswordChangedSuccessfully");
            	this.response.setData(data);
            	break;
            case "OldPasswordIncorrect":
            	this.response.setCode("400");
            	this.response.setMessage("OldPasswordIncorrect");
            	this.response.setData(data);
            	break;
        }
    }
    ...
    public void DeleteResponse(String type) {
        if (this.response == null) {
            this.response = new ApiResponses();
        }
        ...
        switch (type) {
            case "Success":
                this.response.setCode("200");
                this.response.setMessage("Data Deleted Successfully");
                break;
